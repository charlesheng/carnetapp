...
class Carnet:
	...
	def create(self):
		...
		draw.text((idnum_xpos, idnum_ypos + line_size * 0), str(self._employee.pid), (0,0,0), font=font)

		draw.text((name_xpos, name_ypos + line_size * 0), self._employee.name, (0,0,0), font=font)
		draw.text((name_xpos, name_ypos + line_size * 1), self._employee.sname, (0,0,0), font=font)

		draw.text((surname_xpos, surname_ypos + line_size * 0), self._employee.surname, (0,0,0), font=font)
		draw.text((surname_xpos, surname_ypos + line_size * 1), self._employee.ssurname, (0,0,0), font=font)

		draw.text((dpto_xpos, dpto_ypos + line_size * 0), dpmt[0], (0,0,0), font=font2)
		draw.text((dpto_xpos, dpto_ypos + line_size * 1), dpmt[1], (0,0,0), font=font2)
		draw.text((dpto_xpos, dpto_ypos + line_size * 2), dpmt[2], (0,0,0), font=font2)

		draw.text((position_xpos, position_ypos), self._employee.position, (0,0,0), font=font3)
